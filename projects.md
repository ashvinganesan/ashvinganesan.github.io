...
- Designed 3D printed components using Solidworks
...
- Implemented linear regression model for real estate price prediction
...
### Sorting Algorithms
- **Merge Sort**: Implemented divide-and-conquer sorting algorithm
- **Heap Sort**: Built heap-based sorting with O(n log n) complexity
- Performance analysis and comparison with other sorting methods

### Regular Expressions Evaluation
- Created regex engine supporting basic pattern matching
- Implemented in C++ with efficient string processing
- Supports quantifiers, character classes, and grouping
...
### Binary Search Trees
- Implemented balanced BST with insertion, deletion, and search
- Added tree traversal algorithms (inorder, preorder, postorder)
